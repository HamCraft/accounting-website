      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-20 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-8 md:mb-0">
          ...
          <p className="text-gray-600 mb-8 max-w-md text-2xl">
            Expert bookkeeping, tax preparation, and accounting services for businesses and individuals.
          </p>
          <Link href="#contact">
            <Button className="bg-[#3EB7B1] hover:bg-[#35a19c] text-white px-6 py-2 rounded">
              Free Consultation
            </Button>
          </Link>
        </div>
        <div className="md:w-1/2 flex justify-center md:justify-end">
          <Image
            src="/accountant.jpg"
            alt="Taxsation professional offering bookkeeping and tax services"
            width={600}
            height={600}
